...
namespace kcp2k.Tests
{
    public class SegmentTests
    {
        ...
        public void Encode()
        {
            ...
            Assert.That(encoded, Is.EqualTo(25));
            ...
            Assert.That(data[offset + 5], Is.EqualTo(0x07));
            Assert.That(data[offset + 6], Is.EqualTo(0x06));
            Assert.That(data[offset + 7], Is.EqualTo(0x07));
            Assert.That(data[offset + 8], Is.EqualTo(0x08));
            Assert.That(data[offset + 9], Is.EqualTo(0x09));
            Assert.That(data[offset + 10], Is.EqualTo(0x0A));
            Assert.That(data[offset + 11], Is.EqualTo(0x0B));
            Assert.That(data[offset + 12], Is.EqualTo(0x0C));
            Assert.That(data[offset + 13], Is.EqualTo(0x0D));
            Assert.That(data[offset + 14], Is.EqualTo(0x0E));
            Assert.That(data[offset + 15], Is.EqualTo(0x0F));
            Assert.That(data[offset + 16], Is.EqualTo(0x10));
            Assert.That(data[offset + 17], Is.EqualTo(0x11));
            Assert.That(data[offset + 18], Is.EqualTo(0x12));
            Assert.That(data[offset + 19], Is.EqualTo(0x13));
            Assert.That(data[offset + 20], Is.EqualTo(0x14));
            ...
            Assert.That(data[offset + 24], Is.EqualTo(0x00));
        }
